...
/// </summary>
    public interface IEventsGetterService
    {
        ...
        public Task<IEnumerable<EventResponse>?> GetAllEvents(Guid? userId);
        ...
        public Task<IEnumerable<EventResponse>?> GetCreatedEvents(Guid? userId);
        ...
        public Task<IEnumerable<EventResponse>?> GetRegisteredEvents(Guid? userId);
    }
}
